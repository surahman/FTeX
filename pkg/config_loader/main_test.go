...
// ParentLevel1 is an embedded test struct. It is best not to use nested struct definitions for JSON and YAML un/marshalling.
...
// ParentLevel2 is an embedded test struct. It is best not to use nested struct definitions for JSON and YAML un/marshalling.
